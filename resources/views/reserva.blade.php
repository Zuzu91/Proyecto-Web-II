...
<body>
    ...
    <nav>
        ...
        <!-- <ul>
            <li><a href="#" class="navtabla">Productos</a></li>
            <li><a href="#" class="navtabla">Acerca De</a></li>
            <li><a href="#" class="navtabla">Contáctenos</a></li>
        </ul>      -->
    ...
    <div class="cart-actions2">
        ...
        <button class="action-btn" onclick="ShowMessageReservation(document.getElementById('nombreCliente').value)">Reserva</button>
  </div>
